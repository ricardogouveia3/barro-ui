...
describe('Icon', () => {
  ...
  it('should render Heroicon solid variant', () => {
    render(<Icon name="CheckCircleIcon" variant="solid" />);
  ...
  it('should apply custom className', () => {
    render(<Icon name="ArrowUpRightIcon" className="w-6 h-6 text-blue-500" />);
  ...
  it('should apply custom color via style', () => {
    render(<Icon name="ArrowUpRightIcon" color="#FF0000" />);
  ...
  it('should apply custom fill via style', () => {
    render(<Icon name="ArrowUpRightIcon" fill="#00FF00" />);
  ...
  it('should prefer custom icon over name prop', () => {
    ...
    render(<Icon icon={CustomIcon} name="ArrowUpRightIcon" />);
  ...
  it('should warn and return null when icon name is not found', () => {
    const { container } = render(<Icon name="NonExistentIcon" variant="outline" />);
